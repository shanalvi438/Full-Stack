...
//   const year = new Date().getFullYear()
  ...
  return (
    ...
    <footer className='top_footer py-5'>
        ...
        <footer className='bottom_footer py-4'>
            <div className="container">
                <div className="row">
            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-lg-6 col-md-6">
                            <p className='footer__copyright mb-0 align-items-center'>
                                &copy; {new Date().getFullYear()} Powerd by <Link to="https://websourcetech.com.com/">Websource Tech.</Link> All rights reserved </p>
                    </div>
                    <div className="col-lg-6 col-md-6">
