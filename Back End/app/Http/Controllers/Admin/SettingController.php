...
class SettingController extends Controller
{
    public function shippingRate()
    {
        ...
        // dd($divisionList, $districtList, $currency, $currency, $currencyData, $shippingCost);
        // dd($Country);
        return view('adminPanel.setting.shipping_rate')->with(compact('divisionList', 'common_data', 'Country','currencyData','shippingCost','districtList'));
    }
